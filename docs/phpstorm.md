...
* `Symfony Plugin`: Deep integration with Symfony (Contains some paid features) ([Homepage](https://espend.de/phpstorm/plugin/symfony)).
...
* [Symfony Support in PhpStorm (Official Guide)](https://www.jetbrains.com/help/phpstorm/symfony.html)
...
* [PHP Toolbox Plugin](https://plugins.jetbrains.com/plugin/8133-php-toolbox)
